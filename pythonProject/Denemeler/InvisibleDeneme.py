...
class MyGame(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        self.coins_hit_list = None
        self.flower_hit_list = None
    ...
    def coin_generate(self):
        ...
        for i in range(COIN_COUNT):
            ...
            coin = arcade.Sprite(":resources:images/topdown_tanks/treeBrown_small.png",
                                 SPRITE_SCALING_COIN)
            coin.alpha = 0
    ...
    def flower_generate(self):
        ...
        for i in range(COIN_COUNT):
            # Create the coin instance
            # Coin image from kenney.nl
            flower = arcade.Sprite(":resources:images/topdown_tanks/treeBrown_small.png",
                                 SPRITE_SCALING_COIN)
            flower.alpha = 0

            # Position the coin

            flower.center_x = point_list[i][0]
            flower.center_y = point_list[i][1]
    ...
    def setup(self):
        ...
        self.coins_hit_list = arcade.SpriteList()
        self.flower_hit_list = arcade.SpriteList()
        ...
        # Set up the player
        self.player_sprite = Player(":resources:images/enemies/bee.png",
    ...
    def on_update(self, delta_time):
        ...
        self.coins_hit_list = arcade.check_for_collision_with_list(self.player_sprite, self.coin_list)
        self.flower_hit_list = arcade.check_for_collision_with_list(self.player_sprite, self.flower_list)
        # Loop through each colliding sprite, remove it, and add to the score.

        for coin in self.coins_hit_list:
            coin.remove_from_sprite_lists()
            coin.alpha = 250
            self.score += 1

        data = (round(self.total_time, 2), round(self.player_sprite.center_x, 2), round(self.player_sprite.center_y, 2))
