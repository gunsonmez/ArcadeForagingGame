...
#MOVEMENT_SPEED = 5  #Speed is not stable in this condition

MAX_TRIAL = 3  # Trial count
MAX_TIME = 20  # How long each trial takes

COIN_COUNT = 380  # Coins will be generated randomly from a uniform distribution

CSV_TITLES = ["Time", "X_Pos", "Y_Pos"]

CONDITION = "Dispersed_Mouse"
...
class MyGame(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        # Generate random participant number # Not the best way, will change in the future
        self.participantNo = random.randint(1, 100) * 100 + random.randint(1, 100)

        # Data list to store player data
        self.datalist = None
    ...
    def setup(self):
        ...
        # Add to the trial no before starting a new trial
        self.trial += 1
